...
from research_pipeline.paths import INBOX, PROCESSED, REPO_ROOT
...
def _read_text_file(p: Path) -> tuple[str, dict[str, Any]]:
...
def _read_pdf(p: Path) -> tuple[str, dict[str, Any]]:
    try:
