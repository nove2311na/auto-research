...
This folder records MAS agentic-folder improvements by version. Each entry lists what changed, why it matters, and which gates prove the version is usable.

## Files

- `VERSION_HISTORY.md` is the index.
- `v0.1.0-baseline.md` records the preserved strengths from the original MAS folder.
