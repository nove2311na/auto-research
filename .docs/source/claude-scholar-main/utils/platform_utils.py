...
def find_files(dir_path: Path, pattern: str, max_age_days: int | None = None, recursive: bool = False) -> list[dict[str, Any]]:
    """
...
def run_command(cmd: list[str], cwd: Path | None = None, capture: bool = True) -> dict[str, Any]:
    """
