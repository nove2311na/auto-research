...
class VerificationResult:
    ...
    api_source: str | None  # crossref, arxiv, semantic_scholar
    message: str
...
def verify_with_crossref(doi: str) -> dict | None:
...
def verify_with_arxiv(arxiv_id: str) -> dict | None:
    """通过 arXiv API 验证"""
    try:
...
def verify_with_semantic_scholar(title: str, authors: list[str] | None = None) -> dict | None:
...
def verify_existence(entry: dict) -> tuple[bool, str | None, dict | None]:
    """验证论文存在性
