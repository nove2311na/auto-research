...
class CrossRefClient(APIClient):
    ...
    def search(self, doi: str = None, **kwargs) -> dict | None:
        """搜索论文 (统一接口)"""
        if doi:
...
class ArXivClient(APIClient):
    ...
    def search_by_id(self, arxiv_id: str) -> dict | None:
        """通过 arXiv ID 搜索论文
    ...
    def search_by_title(self, title: str, max_results: int = 5) -> dict | None:
        """通过标题搜索论文
    ...
    def search(self, arxiv_id: str = None, title: str = None, **kwargs) -> dict | None:
        """搜索论文 (统一接口)"""
        if arxiv_id:
...
class SemanticScholarClient(APIClient):
    ...
    def search(self, title: str = None, doi: str = None, **kwargs) -> dict | None:
        """搜索论文 (统一接口)"""
        if doi:
            return self.search_by_doi(doi)
        elif title:
...
class CitationAPIManager:
    ...
    def verify_citation(self, citation_info: dict) -> tuple[bool, str | None, dict | None]:
        """验证引用
